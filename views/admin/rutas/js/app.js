    ...
    rutas.forEach(ruta=>{
        ...
        fila.innerHTML +=`
            ...
            <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap">
                <a id="finalizar" class="text-orange-600 font-bold hover:text-orange-900 mantenimiento grid justify-center" href="/rutas/finalizar.html?id=${idVehiculo}">
...
async function mostrarRutas(){
    ...
    rutasFiltradas.forEach((ruta)=>{
        ...
        fila.innerHTML +=`
            ...
            <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap">
                <a id="finalizar" class="text-orange-600 font-bold hover:text-orange-900 mantenimiento grid justify-center" href="/rutas/finalizar.html?id=${id}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 mb-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 0 1 9 9v.375M10.125 2.25A3.375 3.375 0 0 1 13.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 0 1 3.375 3.375M9 15l2.25 2.25L15 12" />
                    </svg>
                </a>
