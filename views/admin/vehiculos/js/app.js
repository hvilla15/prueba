    ...
    vehiculos.forEach((vehiculo)=>{
        ...
        fila.innerHTML +=`
            ...
            <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap grid grid-cols-2">
                <a id="crear-ruta" class="text-white font-bold hover:text-gray-400 grid justify-center" href="/rutas/nuevo.html?id=${id}">
                ...
                <a id="mantenimiento" class="text-orange-600 font-bold hover:text-orange-900 mantenimiento grid justify-center" href="/mantenimiento/nuevo.html?id=${id}">
