...
const obtenerRegistros = async ()=>{
    try{
        ...
        const registros = await resultado.json()
        return registros
    }catch(error){
        console.log(error)
    }
    ...
    registros.forEach(registro=>{
        ...
        fila.innerHTML +=`
            ...
            <td class=" px-3 py-4 border-b border-gray-200 whitespace-nowrap">
                <a id="finalizar" class="text-orange-600 font-bold hover:text-orange-900 mantenimiento grid justify-center" href="http://127.0.0.1:5500/M%C3%B3dulo%206/proyecto/views/mantenimiento/finalizar.html?id=${id}">
                ...
                <a class="text-red-600 font-bold hover:text-red-900 grid justify-center eliminar" href="#" data-registro="${id}">
